            ...
            <el-form-item prop="invokeTarget">
              <span slot="label">
                ...
                <el-tooltip placement="top">
                  <div slot="content">
                    Bean调用示例：Task.Params('func')
                    <br />Class类调用示例：com.hocassian.quartz.task.Task.Params('func')
...
export default {
  ...
  methods: {
    ...
    jobGroupFormat(row, column) {
      return this.selectDictLabelOrigin(this.jobGroupOptions, row.jobGroup);
    },
    // 状态字典翻译
    statusFormat(row, column) {
      return this.selectDictLabelOrigin(this.statusOptions, row.status);
    },
    // 取消按钮
    cancel() {
      this.open = false;
